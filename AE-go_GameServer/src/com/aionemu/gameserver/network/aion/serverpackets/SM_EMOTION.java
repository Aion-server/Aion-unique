...
public class SM_EMOTION extends AionServerPacket
{
	 ...
	 *            who target emotion
	 */
	public SM_EMOTION(int senderObjectId, int emotionType, int emotion, int targetObjectId)
	{
...
//		else
	...
	protected void writeImpl(AionConnection con, ByteBuffer buf)
	{
		...
		switch(emotionType)
		{
			case 0:
				// select target
				writeH(buf, 0x01); // state? (1=normal,2=flyteleport,3=flightmode,7=die,33=??,65=walk)
