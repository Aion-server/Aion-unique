...
import com.aionemu.gameserver.network.aion.clientpackets.unk.CM_UNK9A;
import com.aionemu.gameserver.network.aion.clientpackets.unk.CM_UNKA2;
import com.aionemu.gameserver.network.aion.clientpackets.unk.CM_UNKBB;
import com.aionemu.gameserver.network.aion.clientpackets.unk.CM_UNKFA;
...
public class AionPacketHandlerFactory
{
	...
	public AionPacketHandlerFactory(Injector injector)
	{
		...
		addPacket(new CM_UNK08(0x11), State.IN_GAME);
		addPacket(new CM_UNK27(0x27), State.IN_GAME);
		addPacket(new CM_UNK8B(0x8B), State.IN_GAME);
		addPacket(new CM_UNK9A(0x9A), State.IN_GAME);
		addPacket(new CM_UNKA2(0xA2), State.IN_GAME);
		addPacket(new CM_UNKBB(0xB4), State.IN_GAME);
		addPacket(new CM_UNKFA(0x83), State.IN_GAME);
