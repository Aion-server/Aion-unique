...
public class RiftSpawnManager
{
	...
	private enum RiftEnum
	{
		...
		HEIRON_AM("HEIROM_AM", "BELUSLAN_AS", 24, 35),
		HEIRON_BM("HEIROM_BM", "BELUSLAN_BS", 36, 35),
		HEIRON_CM("HEIROM_CM", "BELUSLAN_CS", 48, 46),
		HEIRON_DM("HEIROM_DM", "BELUSLAN_DS", 48, 40),
		HEIRON_EM("HEIROM_EM", "BELUSLAN_ES", 60, 50),
		HEIRON_FM("HEIROM_FM", "BELUSLAN_FS", 60, 50),
		HEIRON_GM("HEIROM_GM", "BELUSLAN_GS", 72, 50),
